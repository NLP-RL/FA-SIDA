...
def construct_info(params):
    ...
    checkpoint_path = "/Data/abhisektiwari/intSS/LUD_Results/" + params["dataset_type"] + "/model/" + dqn_type + "/checkpoint/" + info
    params["checkpoint_path"] = checkpoint_path

    performance_save_path = "/Data/abhisektiwari/intSS/LUD_Results/" + params["dataset_type"] + "/model/" + dqn_type + "/performance/"
    params["performance_save_path"] = performance_save_path

    visit_save_path = "/Data/abhisektiwari/intSS/LUD_Results/" + params["dataset_type"] + "/model/" + dqn_type + "/visit/"

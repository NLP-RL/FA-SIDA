...
parser.add_argument("--log_dir", dest="log_dir", type=str, default="", help="directory where event file of training will be written, ending with /")
...
parser.add_argument("--save_disease_record", dest="save_disease_record", type=boolean_string, default=False, help="Save the dialogue? [True, False]")
parser.add_argument("--disease_record_file", dest="disease_record_file", type=str, default="", help="location where disease_record file is saved")
parser.add_argument("--run_id", dest='run_id', type=int, default=0, help='the id of this running.')

# user configuration.
parser.add_argument("--allow_wrong_disease", dest="allow_wrong_disease", type=boolean_string, default=False, help="Allow the agent to inform wrong disease? Yes or No")

# configuration of the knowledge provided to the model upon incorrect disease prediction
parser.add_argument("--wrong_disease_knowledge", dest="wrong_disease_knowledge", type=boolean_string, default=False, help="Provide the wrong disease information to agent upon incorrect prediction? Yes or No") 
parser.add_argument("--sf_idf_knowledge", dest="sf_idf_knowledge", type=boolean_string, default=False, help="Provide the sf-idf information to agent upon incorrect prediction? Yes or No")
...
parser.add_argument("--dataset_type", dest="dataset_type", type=str, default="SD", help="Which dataset is being utilized? SD or MD")
parser.add_argument("--dataset_location", dest="dataset_location", type=str, default='/Data/abhisektiwari/intSS/Final_LUDV0_Sub/Code/src/classifier/data/sd_dataset', help="location of the dataset")

# goal set, slot set, action set.
max_turn = 22
file0 = '/Data/abhisektiwari/intSS/LUD_Code/src/classifier/data/sd_dataset'
...
parser.add_argument("--sf_idf_matrix", dest="sf_idf_matrix", type=str, default=file0+'/sf_idf_matrix.p', help="path and filename of sf_idf_matrix")
parser.add_argument("--disease2id", dest="disease2id", type=str, default=file0+'/disease2id.p', help="path and filename of disease2id")
...
parser.add_argument("--reward_for_inform_wrong_disease", dest="reward_for_inform_wrong_disease", type=float, default=-55.0, help="reward for informing wrong disease")
...
parser.add_argument('--file_all', dest="file_all", type=str, default=file0, help='the path for given groups of diseases')
parser.add_argument("--label_all_model_path", dest="label_all_model_path", type=str, default='')
...
if __name__ == "__main__":
    ...
    if parameter.get("dataset_type") == "MD":
        ...
        parameter["file_all"] = parameter["dataset_location"]
        parameter["action_set"] = parameter["dataset_location"] + '/action_set.p'
        parameter["slot_set"] = parameter["dataset_location"] + '/slot_set.p'
        parameter["goal_set"] = parameter["dataset_location"] + '/goal_set.p'
        parameter["disease_symptom"] = parameter["dataset_location"] + "/disease_symptom.p"
        parameter["sf_idf_matrix"] = parameter["dataset_location"] + "/sf_idf_matrix.p"
        parameter["disease2id"] = parameter["dataset_location"] + "/disease2id.p"

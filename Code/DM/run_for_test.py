...
parser.add_argument("--log_dir", dest="log_dir", type=str, default="/Data/abhisektiwari/intSS/Wrong_Disease_Experiment_Results/log/", help="directory where event file of training will be written, ending with /")
...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="./Wrong_Disease_Experiment_Results/model/DQN/checkpoint/0722103651_agenthrljoint2_T22_ss100_lr0.0005_RFS66_RFF0_RFNCY0.0_RFIRS0_RFRA-44_RFRMT-66_mls0_gamma0.95_gammaW0.9_epsilon0.1_awd1_crs0_hwg0_wc0_var0_sdai0_wfrs44.0_dtft0_ird0_ubc0.985_lbc1e-10_dataSynthetic_Dataset_RID0/")
parser.add_argument("--save_dialogue", dest="save_dialogue", type=boolean_string, default=True, help="Save the dialogue? [True, False]")
parser.add_argument("--dialogue_file", dest="dialogue_file", type=str, default="/Data/abhisektiwari/intSS/Wrong_Disease_Experiment_Results/data/dialogue_output/dialogue_file_test.txt", help="the file that used to save dialogue content.")
...
# goal set, slot set, action set.
max_turn = 22
file0 = '/Data/abhisektiwari/intSS/Wrong_Disease_Experiment_Code/src/classifier/data/synthetic_dataset'
...
# The below 'disease_symptom_matrix' file is a dictionary with keys as diseases and values as symptoms that have the highest sf-idf value with the disease.
# Note that the keys and values in the dictinary are stored in the form of IDs. Their actual names can be inferred from the disease2id and symptom2id files.
parser.add_argument("--disease_symptom_matrix", dest="disease_symptom_matrix", type=str, default=file0+'/disease_symptom_matrix.p', help="path and filename of the external disease_symptom matrix file")
parser.add_argument("--disease2id", dest="disease2id", type=str, default=file0+'/disease2id.p', help="the disease2id file")
...
if __name__ == "__main__":
    ...
    checkpoint_path = "../Wrong_Disease_Experiment_Results/model/DQN/checkpoint"
    # Flat-DQN, ss1
    # agent_id = 'AgentDQN'
